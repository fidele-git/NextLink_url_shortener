...
ALLOWED_HOSTS = env.list('ALLOWED_HOSTS', default=['localhost', '127.0.0.1', 'nextlink.onrender.com'])
...
ROOT_URLCONF = 'nexlink_project.urls'
...
WSGI_APPLICATION = 'nexlink_project.wsgi.application'
    ...
    'default': {
        ...
        'OPTIONS': {
            ...
            'CONNECTION_POOL_KWARGS': {
                'ssl_cert_reqs': None  # Useful for Upstash/managed Redis with self-signed certs
            }
        }
    }
}
...
UNFOLD = {
    "SITE_TITLE": "NexLink Admin",
    "SITE_HEADER": "NexLink Dashboard",
    "SITE_URL": "/",
    
    # Colors - matching NexLink primary blue
    "COLORS": {
        "primary": {
            "50": "239 246 255",
            "100": "219 234 254",
